...
const MyAppointments = () => {
    ...
    const joinVideoCall = (appointmentId) => {
        const roomName = `appointment-${appointmentId}`; // Generate a unique room name
        navigate(`/video-call?roomName=${roomName}`);
    };
                        ...
                        <div className="flex flex-col gap-2 justify-end text-sm text-center">
                            ...
                            {!item.cancelled && item.payment && !item.isCompleted && (
                                <button
                                    ...
                                    className="sm:min-w-48 py-2 border rounded text-[#696969] bg-[#EAEFFF] hover:bg-primary hover:text-white transition-all duration-300"
                                >
                                    Join Call
                                </button>
                            )}
